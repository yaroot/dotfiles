...
alias urldecode='python3 -c "for l in __import__(\"sys\").stdin.readlines(): print(__import__(\"urllib.parse\").parse.unquote_plus(l).strip())"'
alias urlencode='python3 -c "for l in __import__(\"sys\").stdin.readlines(): print(__import__(\"urllib.parse\").parse.quote_plus(l).strip())"'
